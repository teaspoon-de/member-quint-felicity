...
<section class="section edit">
    <a href="<?php echo $self ? '/account/edit/password' : '/members/' . $user['id'] . '/edit/password'; ?>">
    ...
    <form id="editForm" action="<?php echo $self ? '/account/edit' : '/members/' . $user['id'] . '/edit'; ?>" method="post">
        <div class="inLong">
