...
<section class="section edit">
    <form id="editForm" action="/setlists/<?= $setlist['id'] ?>/edit" method="post">
        <div class="inLong">
            <h3>Titel</h3>
            <input
                type="text" 
                id="name" 
                name="name" 
                value="<?= htmlspecialchars($setlist['name'] ?? '') ?>"
                required
            >
        </div>

        <div id="addSong" class="editContextButton">
